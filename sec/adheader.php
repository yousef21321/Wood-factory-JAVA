    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="admin.php">Add manager</a></li>
                            <li><a href="viewadmin.php">View manager</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="list">
                    <li class="active open"><a href="http://localhost:8081/order/order.php"><i
                                class="zmdi zmdi-calendar-check"></i><span>Order</span></a></li>
                                </ul>
            ...
            <div class="menu">
                ...
                <ul class="list">
                    <li class="active open"><a href="http://localhost:8081/order/shop.php"><i
                                class="zmdi zmdi-calendar-check"></i><span>Order</span></a></li>
                                </ul>
                </ul>
            </div>
