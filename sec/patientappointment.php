                        ...
                        <div class="col-lg-7">
                            ...
                            ?>
                             ...
                             ?>
                                        ...
                                        <li class="col-sm-12">
                                            <button  type="submit" class="btn" name="submit" id="submit" onclick="document.location = 'http://localhost:8081/phpmailer3/' , http://localhost:8081/phpmailer2/" >make an
                                                appointment</button>
                                        
                                        <button onclick="document.location = 'http://localhost:8081/phpmailer2/'"> Authentication</button>
                                        </li>
                                </form>
                            </div>
                        </div>
